...
# Connect to Data Server to retrieve data
data_ip = 'localhost'
data_port = 50051
...
class HashServicer(hservice_pb2_grpc.HSServicer):
    def GetHash(self, request, context):
        ...
        # Step 1: Retrieve data from data server using passcode
        ...
        # Step 2: Compute SHA256 hash of the retrieved data
        hash = hashlib.sha256(data_response.msg.encode()).hexdigest()  # Encode data to bytes, compute SHA256, convert to hex string

        # Step 3: Return hash response
